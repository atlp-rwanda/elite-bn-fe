        ...
        if(trips.length > 0) {
          ...
          return (
              ...
              trips.map((trip, index) =>{
                ...
                return (
                  <Card sx={{ display: 'flex', boxShadow:'none',   padding: '30px 0',borderRadius:0, borderBottom:'5px solid #CCCCCC'}}>
                  <CardMedia
                      component="img"
                  ...
                  />
                    <Box sx={{ display: 'flex', flexDirection: 'column', width:'70%', padding:'0 0 0 10px'}}>
                      <CardContent sx={{  padding:'0 0 15px 0', display:'flex', justifyContent:'space-between'}} >
                        ...
                        <Box>
                          <Typography  sx={{ border:`1px solid green`, color: 'green', borderRadius:'20px', padding:'2px 10px', fontSize:'0.8rem', textTransform:'none'}}>
                            {trip.tripStatus}
                          </Typography>
                        </Box>
                      </CardContent>
                      ...
                      <Box sx={{ float: 'left', pl: 1, pb: 2, textAlign:'start',maxWidth:'500px' }}>
                        <Typography variant="p" color="text.secondary" component="div" sx={{textAlign:'start', display:'inline-block',paddingRight:'30px'}}>
                          <span style={{color:'black'}}>From: </span>{trip.from}
                        </Typography>
                        <Typography variant="p" color="text.secondary" component="div" sx={{textAlign:'start', display:'inline-block',paddingRight:'30px'}}>
                          <span style={{color:'black'}}>To: </span>{trip.destination.locationName}
                        </Typography>
                      </Box>
                      <Box sx={{ float: 'left', pl: 1, pb: 2, textAlign:'start',maxWidth:'500px' }}>
                        <Typography variant="p" color="text.secondary" component="div" sx={{textAlign:'start', display:'inline-block',paddingRight:'30px'}}>
                          <span style={{color:'black'}}>Departure date: </span>{trip.departDate}
                        </Typography>
                        <Typography variant="p" color="text.secondary" component="div" sx={{textAlign:'start', display:'inline-block',paddingRight:'30px'}}>
                          <span style={{color:'black'}}>Return date: </span>{trip.returnDate}
                        </Typography>
                      </Box>
                      <Box sx={{ float: 'left', pl: 1, pb: 2, textAlign:'start',maxWidth:'500px' }}>
                        <Typography variant="p" color="text.secondary" component="div" sx={{textAlign:'start', display:'inline-block',paddingRight:'30px'}}>
                         <span style={{color:'black'}}>Trip Reasons: </span>{trip.tripReasons}
                        </Typography>
                      </Box>
                      <Box sx={{ float: 'left', pl: 1, pb: 2, textAlign:'start',maxWidth:'500px' }}>
                        <Typography variant="p" color="text.secondary" component="div" sx={{textAlign:'start', display:'inline-block',paddingRight:'30px'}}>
                        ...
                        <Typography  variant="p" color="text.secondary" component="div" sx={{textAlign:'start', margin:' auto 0 0 0', fontWeight:'600', cursor:'pointer'}}>
                          ...
                          <Box>
                            <ThemeProvider theme={theme}>
                              <Button  variant="contained"  color="neutral" size="medium"  sx={{ marginRight:'10px',textTransform:'none'}}>
                                Update
                              </Button>
                          </ThemeProvider>
